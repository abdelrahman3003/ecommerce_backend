...
function checkAuthenticate()
{
   if (isset($_SERVER['PHP_AUTH_USER'])  && isset($_SERVER['PHP_AUTH_PW'])) {
      if ($_SERVER['PHP_AUTH_USER'] != "temsah13" ||  $_SERVER['PHP_AUTH_PW'] != "16797346") {
...
function printFailure($errorMessage = "none")
{

   echo json_encode(array("status" => "failure", "message" => $errorMessage));
}
function printSucess($success)
{
   echo ($success);
}
...
function sendGCM($title, $message, $topic, $pageid, $pagename)
{
   ...
   $headers = array(
      'Authorization: key=' . "AAAA0K64HR0:APA91bFkMwJiq1rbwKkgdbbSKIYnvL6_CBDFrAiRUPOwWtxEMat7vz4X7o51wZmHBBaBYc_OYpHQoviXtC98GcfKR92_zm1e4oSJdtE6kLh5Ws_wQccLWY4vmk7wEiPByh54PurzpU6N",
